  ...
  <div class="app-container">
    <div class="user-info">
      <el-collapse v-model="activeNames">
        ...
        <el-collapse-item title="用户组织" name="2">
          <div>{{ userData.orgName }}</div>
        </el-collapse-item>
        <el-collapse-item title="用户链上地址" name="3">
          <div>{{ userData.publicKey }}</div>
        </el-collapse-item>
        <el-collapse-item title="合约名称" name="4">
          <div>{{ userData.contractName }}</div>
        </el-collapse-item>
        <el-collapse-item title="合约创建时间" name="5">
          <div>{{ userData.createTimeStr }}</div>
        </el-collapse-item>
        <el-collapse-item title="合约地址" name="6">
